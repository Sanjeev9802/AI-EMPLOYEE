        ...
        if analysis_type == "Linear Regression":
            ...
            if st.button("Run Linear Regression"):
                ...
                fig.add_trace(go.Scatter(x=cleaned_data[cleaned_data.columns[0]],
                                         ...
                                         name='Fitted Line'))
                st.plotly_chart(fig)
                image_data = save_plot_as_image(fig, "linear_regression_plot.png")
                charts.append("![Linear Regression Plot](data:image/png;base64," + base64.b64encode(image_data).decode() + ")")
            ...
            if st.button("Run K-Means Clustering"):
                ...
                st.plotly_chart(fig)
                image_data = save_plot_as_image(fig, "kmeans_clustering_plot.png")
                charts.append("![K-Means Clustering Plot](data:image/png;base64," + base64.b64encode(image_data).decode() + ")")
            ...
            if st.button("Run Decision Tree Classification"):
                ...
                with tempfile.NamedTemporaryFile(delete=False, suffix=".png") as tmpfile:
                    ...
                    with open(tmpfile.name, "rb") as f:
                        image_data = f.read()
                charts.append("![Decision Tree Plot](data:image/png;base64," + base64.b64encode(image_data).decode() + ")")
